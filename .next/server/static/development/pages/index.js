...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Index, [{
    ...
    value: function componentDidMount() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_10___default.a.get("static/content/blog.json").then(function (res) {
        var blog = res.data;
    ...
    value: function render() {
      ...
      var blogItems = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.state.blog).map(function (item, index) {
        var blogItem = _this3.state.blog[item].map(function (v) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_components_MyLayout_js__WEBPACK_IMPORTED_MODULE_9__["default"], {
        ...
        __self: this
      }, "Home"), _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.state.blog).map(function (item, index) {
        _this3.state.blog[item].map(function (v) {
          return "<p> ".concat(v.front.title, "</p>");
        }).join("");
      }));
    }
  }]);
...
module.exports = __webpack_require__(/*! /Users/harry.beckwith/Desktop/naomi-port/pages/index.js */"./pages/index.js");
