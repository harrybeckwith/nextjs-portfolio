...
// EXTERNAL MODULE: ./styles/gallery.scss
var gallery = __webpack_require__("py+v");

// EXTERNAL MODULE: ./components/MyLayout.js + 7 modules
var MyLayout = __webpack_require__("3Hq7");

// CONCATENATED MODULE: ./static/gallery/croatia.js
var croatia_gallery = [{
...
/* harmony default export */ var croatia = (croatia_gallery);
// CONCATENATED MODULE: ./static/gallery/corsica.js
var corsica_gallery = [{
...
/* harmony default export */ var corsica = (corsica_gallery);
...
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(Gallery, _React$Component);
  ...
  function Gallery() {
    ...
    Object(classCallCheck["a" /* default */])(this, Gallery);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(Gallery)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "imageClick", function (current) {
      _this.setState({
        current: current,
        active: true
      });
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "hideLb", function () {
      _this.setState({
        active: false
      });
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "next", function () {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "prev", function () {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "changeGallery", function (name) {
      if (name === 'croatia') {
        _this.setState({
          gallery: croatia
        });
  ...
  Object(createClass["a" /* default */])(Gallery, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      }, "Croatia"), external_react_default.a.createElement("div", {
        className: "lightbox__btns__btn btn--croatia",
        onClick: function onClick() {
          return _this2.changeGallery('corsica');
        }
      }, "Corsica")), external_react_default.a.createElement("div", {
        className: "gallery"
      }, external_react_default.a.createElement("div", {
      ...
      }, this.state.gallery[this.state.current].caption), external_react_default.a.createElement("img", {
